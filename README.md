...
1. After that, locate the `src/main/java/Fanta.java` file, right-click it, and choose `Run Fanta.main()` (if the code editor is showing compile errors, try restarting the IDE).
